...
mixin _$VideoSettings {
 ...
 PlayerLayoutSettings get layout; GestureSettings get gestures; AudioSettings get audio; SubtitleSettings get subtitles; CacheSettings get cache; bool get savePositionOnQuit; bool get autoplayNextVideo; String get streamingProfile; bool get downloadSchedulerEnabled; int get downloadStartHour; int get downloadEndHour; String get customMpvOptions; String get downloadSpeedLimit; String get progressSyncMode; bool get rememberSpeed; bool get wifiOnlyDownloads; String get hardwareDecoderMode; int? get proxyPingLimit; String get defaultDownloadQuality; String get batchDownloadQuality; bool get showQualityBadges; bool get enableInPlayerQualitySwitch; String get videoEngine;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is VideoSettings&&(identical(other.layout, layout) || other.layout == layout)&&(identical(other.gestures, gestures) || other.gestures == gestures)&&(identical(other.audio, audio) || other.audio == audio)&&(identical(other.subtitles, subtitles) || other.subtitles == subtitles)&&(identical(other.cache, cache) || other.cache == cache)&&(identical(other.savePositionOnQuit, savePositionOnQuit) || other.savePositionOnQuit == savePositionOnQuit)&&(identical(other.autoplayNextVideo, autoplayNextVideo) || other.autoplayNextVideo == autoplayNextVideo)&&(identical(other.streamingProfile, streamingProfile) || other.streamingProfile == streamingProfile)&&(identical(other.downloadSchedulerEnabled, downloadSchedulerEnabled) || other.downloadSchedulerEnabled == downloadSchedulerEnabled)&&(identical(other.downloadStartHour, downloadStartHour) || other.downloadStartHour == downloadStartHour)&&(identical(other.downloadEndHour, downloadEndHour) || other.downloadEndHour == downloadEndHour)&&(identical(other.customMpvOptions, customMpvOptions) || other.customMpvOptions == customMpvOptions)&&(identical(other.downloadSpeedLimit, downloadSpeedLimit) || other.downloadSpeedLimit == downloadSpeedLimit)&&(identical(other.progressSyncMode, progressSyncMode) || other.progressSyncMode == progressSyncMode)&&(identical(other.rememberSpeed, rememberSpeed) || other.rememberSpeed == rememberSpeed)&&(identical(other.wifiOnlyDownloads, wifiOnlyDownloads) || other.wifiOnlyDownloads == wifiOnlyDownloads)&&(identical(other.hardwareDecoderMode, hardwareDecoderMode) || other.hardwareDecoderMode == hardwareDecoderMode)&&(identical(other.proxyPingLimit, proxyPingLimit) || other.proxyPingLimit == proxyPingLimit)&&(identical(other.defaultDownloadQuality, defaultDownloadQuality) || other.defaultDownloadQuality == defaultDownloadQuality)&&(identical(other.batchDownloadQuality, batchDownloadQuality) || other.batchDownloadQuality == batchDownloadQuality)&&(identical(other.showQualityBadges, showQualityBadges) || other.showQualityBadges == showQualityBadges)&&(identical(other.enableInPlayerQualitySwitch, enableInPlayerQualitySwitch) || other.enableInPlayerQualitySwitch == enableInPlayerQualitySwitch)&&(identical(other.videoEngine, videoEngine) || other.videoEngine == videoEngine));
}


@override
int get hashCode => Object.hashAll([runtimeType,layout,gestures,audio,subtitles,cache,savePositionOnQuit,autoplayNextVideo,streamingProfile,downloadSchedulerEnabled,downloadStartHour,downloadEndHour,customMpvOptions,downloadSpeedLimit,progressSyncMode,rememberSpeed,wifiOnlyDownloads,hardwareDecoderMode,proxyPingLimit,defaultDownloadQuality,batchDownloadQuality,showQualityBadges,enableInPlayerQualitySwitch,videoEngine]);

@override
String toString() {
  return 'VideoSettings(layout: $layout, gestures: $gestures, audio: $audio, subtitles: $subtitles, cache: $cache, savePositionOnQuit: $savePositionOnQuit, autoplayNextVideo: $autoplayNextVideo, streamingProfile: $streamingProfile, downloadSchedulerEnabled: $downloadSchedulerEnabled, downloadStartHour: $downloadStartHour, downloadEndHour: $downloadEndHour, customMpvOptions: $customMpvOptions, downloadSpeedLimit: $downloadSpeedLimit, progressSyncMode: $progressSyncMode, rememberSpeed: $rememberSpeed, wifiOnlyDownloads: $wifiOnlyDownloads, hardwareDecoderMode: $hardwareDecoderMode, proxyPingLimit: $proxyPingLimit, defaultDownloadQuality: $defaultDownloadQuality, batchDownloadQuality: $batchDownloadQuality, showQualityBadges: $showQualityBadges, enableInPlayerQualitySwitch: $enableInPlayerQualitySwitch, videoEngine: $videoEngine)';
}
...
as int?,defaultDownloadQuality: null == defaultDownloadQuality ? _self.defaultDownloadQuality : defaultDownloadQuality // ignore: cast_nullable_to_non_nullable
as String,batchDownloadQuality: null == batchDownloadQuality ? _self.batchDownloadQuality : batchDownloadQuality // ignore: cast_nullable_to_non_nullable
as String,showQualityBadges: null == showQualityBadges ? _self.showQualityBadges : showQualityBadges // ignore: cast_nullable_to_non_nullable
as bool,enableInPlayerQualitySwitch: null == enableInPlayerQualitySwitch ? _self.enableInPlayerQualitySwitch : enableInPlayerQualitySwitch // ignore: cast_nullable_to_non_nullable
as bool,videoEngine: null == videoEngine ? _self.videoEngine : videoEngine // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
/// Create a copy of VideoSettings
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( PlayerLayoutSettings layout,  GestureSettings gestures,  AudioSettings audio,  SubtitleSettings subtitles,  CacheSettings cache,  bool savePositionOnQuit,  bool autoplayNextVideo,  String streamingProfile,  bool downloadSchedulerEnabled,  int downloadStartHour,  int downloadEndHour,  String customMpvOptions,  String downloadSpeedLimit,  String progressSyncMode,  bool rememberSpeed,  bool wifiOnlyDownloads,  String hardwareDecoderMode,  int? proxyPingLimit,  String defaultDownloadQuality,  String batchDownloadQuality,  bool showQualityBadges,  bool enableInPlayerQualitySwitch,  String videoEngine)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _VideoSettings() when $default != null:
return $default(_that.layout,_that.gestures,_that.audio,_that.subtitles,_that.cache,_that.savePositionOnQuit,_that.autoplayNextVideo,_that.streamingProfile,_that.downloadSchedulerEnabled,_that.downloadStartHour,_that.downloadEndHour,_that.customMpvOptions,_that.downloadSpeedLimit,_that.progressSyncMode,_that.rememberSpeed,_that.wifiOnlyDownloads,_that.hardwareDecoderMode,_that.proxyPingLimit,_that.defaultDownloadQuality,_that.batchDownloadQuality,_that.showQualityBadges,_that.enableInPlayerQualitySwitch,_that.videoEngine);case _:
  return orElse();
...
@override@JsonKey() final  String defaultDownloadQuality;
@override@JsonKey() final  String batchDownloadQuality;
@override@JsonKey() final  bool showQualityBadges;
@override@JsonKey() final  bool enableInPlayerQualitySwitch;
@override@JsonKey() final  String videoEngine;
