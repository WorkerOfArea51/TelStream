...
mixin _$VideoSettings {
 ...
 PlayerLayoutSettings get layout; GestureSettings get gestures; AudioSettings get audio; SubtitleSettings get subtitles; CacheSettings get cache; bool get savePositionOnQuit; bool get autoplayNextVideo; String get streamingProfile; bool get downloadSchedulerEnabled; int get downloadStartHour; int get downloadEndHour; String get customMpvOptions; String get downloadSpeedLimit; String get progressSyncMode; bool get rememberSpeed; bool get wifiOnlyDownloads; String get hardwareDecoderMode; int? get proxyPingLimit; String get defaultDownloadQuality; bool get showQualityBadges; bool get enableInPlayerQualitySwitch;
...
@override
int get hashCode => Object.hashAll([runtimeType,layout,gestures,audio,subtitles,cache,savePositionOnQuit,autoplayNextVideo,streamingProfile,downloadSchedulerEnabled,downloadStartHour,downloadEndHour,customMpvOptions,downloadSpeedLimit,progressSyncMode,rememberSpeed,wifiOnlyDownloads,hardwareDecoderMode,proxyPingLimit,defaultDownloadQuality,showQualityBadges,enableInPlayerQualitySwitch]);

@override
String toString() {
  return 'VideoSettings(layout: $layout, gestures: $gestures, audio: $audio, subtitles: $subtitles, cache: $cache, savePositionOnQuit: $savePositionOnQuit, autoplayNextVideo: $autoplayNextVideo, streamingProfile: $streamingProfile, downloadSchedulerEnabled: $downloadSchedulerEnabled, downloadStartHour: $downloadStartHour, downloadEndHour: $downloadEndHour, customMpvOptions: $customMpvOptions, downloadSpeedLimit: $downloadSpeedLimit, progressSyncMode: $progressSyncMode, rememberSpeed: $rememberSpeed, wifiOnlyDownloads: $wifiOnlyDownloads, hardwareDecoderMode: $hardwareDecoderMode, proxyPingLimit: $proxyPingLimit, defaultDownloadQuality: $defaultDownloadQuality, showQualityBadges: $showQualityBadges, enableInPlayerQualitySwitch: $enableInPlayerQualitySwitch)';
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( PlayerLayoutSettings layout,  GestureSettings gestures,  AudioSettings audio,  SubtitleSettings subtitles,  CacheSettings cache,  bool savePositionOnQuit,  bool autoplayNextVideo,  String streamingProfile,  bool downloadSchedulerEnabled,  int downloadStartHour,  int downloadEndHour,  String customMpvOptions,  String downloadSpeedLimit,  String progressSyncMode,  bool rememberSpeed,  bool wifiOnlyDownloads,  String hardwareDecoderMode,  int? proxyPingLimit,  String defaultDownloadQuality,  bool showQualityBadges,  bool enableInPlayerQualitySwitch)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _VideoSettings() when $default != null:
return $default(_that.layout,_that.gestures,_that.audio,_that.subtitles,_that.cache,_that.savePositionOnQuit,_that.autoplayNextVideo,_that.streamingProfile,_that.downloadSchedulerEnabled,_that.downloadStartHour,_that.downloadEndHour,_that.customMpvOptions,_that.downloadSpeedLimit,_that.progressSyncMode,_that.rememberSpeed,_that.wifiOnlyDownloads,_that.hardwareDecoderMode,_that.proxyPingLimit,_that.defaultDownloadQuality,_that.showQualityBadges,_that.enableInPlayerQualitySwitch);case _:
  return orElse();
